...
//		}
        ...
        $.post("<?php echo U('Verify/findpaypwd');?>",{moble:moble,verify:verify},function(data){
...
//		}
        ...
        if(password!=repassword){
            ...
            layer.tips('确认交易密码错误','#repassword',{tips:3});

            return false;

        }

        $.post("<?php echo U('Login/findpaypwd');?>",{moble:moble,moble_verify:moble_verify,verify:verify,password:password,repassword:repassword},function(data){
