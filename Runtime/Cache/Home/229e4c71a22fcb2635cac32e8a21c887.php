    ...
    <div class="mui-content1">
        <div class="main-form1" id="none">
            <form action="">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <input type="text"  name="bankcard" id="bankcard" placeholder="银行卡帐号" value="<?php echo ($user["bankcard"]); ?>">
                </div>
                <div class="form-group">
                    <input type="text"  name="bank" id="bank" placeholder="银行名称" value="<?php echo ($user["bank"]); ?>">
                </div>
                 <div class="form-group">
                    <input type="text"  name="bankaddr" id="bankaddr" placeholder="开户支行" value="<?php echo ($user["bankaddr"]); ?>">
                </div>
                <div class="form-group">
        ...
        <div class="main-form1" id="onlyread">
            <form action="">
                ...
                <div class="form-group">
                    银行卡号:<?php echo ($user["bankcard"]); ?>
                </div>
                <div class="form-group">
                    银行名称:<?php echo ($user["bank"]); ?>
                </div>
                <div class="form-group">
                    开户支行:<?php echo ($user["bankaddr"]); ?>
                </div>
...
<script>
    ...
    function Update(){
        ...
        $.post("<?php echo U('User/upbank');?>",{type:'bank',id:id,name:name,bank:bank,bankaddr:bankaddr,bankcard:bankcard,paypassword:paypassword},function(data){

            if(data.status==1){

                layer.msg(data.info,{icon:1});

                window.location="<?php echo U('User/bank');?>";
