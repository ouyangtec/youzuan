...
<body>
	...
	<div id="dialog_ali" class="mana-app styled-pane">
		...
		<div class="mana-app-title"><?php echo ($myczType['title']); ?>
		...
		<div class="lighttips">请您通过网银或柜台向以下银行账户转账汇款，若有疑问请 <a

				href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo ($C['contact_qq'][0]); ?>&amp;site=qq&amp;menu=yes"
		...
		<div class="clearfix cz-form-box">
			<form>
				<table class="mana-app-table info">
					...
					<tr>
						<td>银行代号：</td>
						<td><?php echo ($myczType["daihao"]); ?></td>
					</tr>

					<tr>
						<td>开户支行：</td>
						<td><?php echo ($myczType["zhihang"]); ?></td>
					</tr>
					...
					<tr>
						...
						<td><em class="cnyin_msg"
								style="color:red;font-style:normal;font-weight: bold;"><?php echo ($mycz["tradeno"]); ?></em></td>
					</tr>
					</tbody>
				</table>
			</form>
			<!--<?php if(!empty($myczType['img'])): ?><div class="pay_code pay_code1">
					<img src="/Upload/public/<?php echo ($myczType['img']); ?>" width="130">
					<p>官网收款银行账号</p>
					<p>扫描二维码进行转账</p>
				</div><?php endif; ?>-->
		</div>
		<div class="pay_con_r">
			<p>请在汇款［备注/附言］中严格按要求填写充值订单编号：<em class="cnyin_msg"
											 style="font-weight: bold;color:#e55600;font-style:normal;color:red;"><?php echo ($mycz["tradeno"]); ?></em><br>
				不要填写其它字符（比特币、莱特币等），否则不能正确到账！<br>
				我们会在收到汇款后20分钟内为您入账，在此期间无需联系客服，如有问题我们会主动联系您。</p>
		</div>
