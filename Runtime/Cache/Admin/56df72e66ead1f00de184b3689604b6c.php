...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">求购市场</span>
        </div>

        <div class="cf">
            <div class="fl">
                <a class="btn btn-success " href="<?php echo U('Trade/seekedit');?>">新 增</a>
                <button class="btn ajax-post btn-info"
                        url="<?php echo U('Trade/seekStatus',array('type'=>'resume'));?>" target-form="ids">启 用
                </button>
                <button class="btn ajax-post btn-warning "
                        url="<?php echo U('Trade/seekStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用
                </button>
                <button class="btn ajax-post confirm btn-danger "
                        url="<?php echo U('Trade/seekStatus',array('type'=>'del'));?>" target-form="ids">删 除
                </button>
            </div>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(($vo["name"]) != "cny"): ?><a href="<?php echo U('Trade/seekEdit?id='.$vo['id']);?>"
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Trade/seekmarket');?>");
    </script>