...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="main-title-h">
            ...
            <span class="h1-title">C2C充值</span>
        ...
        <div class="data-table table-striped">
            ...
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <!-- <?php if(($vo["status"]) == "0"): ?><a href="<?php echo U('Finance/myczQueren?id='.$vo['id']);?>"
                                       class="ajax-get btn btn-primary btn-xs">确认到账 </a><?php endif; ?> -->
                                <?php if(($vo["status"]) == "3"): ?><a href="<?php echo U('Finance/myczQueren?id='.$vo['id']);?>"
                                       class="ajax-get btn btn-primary btn-xs">确认到账 </a><?php endif; ?>
                            </td>
