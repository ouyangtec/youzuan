	...
	<div id="main" class="main">
		...
		<div class="cf">
			...
			<div class="search-form fr cf">
				<div class="sleft">
					<form action="<?php echo ((isset($searchPostUrl) && ($searchPostUrl !== ""))?($searchPostUrl):'/Admin/Fenhong/log/p/1/order/id_desc.html'); ?>" name="formSearch" id="formSearch" method="get" name="form1">
