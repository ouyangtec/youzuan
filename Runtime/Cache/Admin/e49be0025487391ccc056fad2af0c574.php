...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">金钻发放</span>
        </div>
        <div class="tab-wrap">
            <div class="tab-content">
                <form id="form" action="<?php echo U('Config/goldsend');?>" method="post" class="form-horizontal">
                    <div id="tab" class="tab-pane in tab">
                        <div class="form-item cf">
                            <table>

                                <tr class="controls">
                                    <td class="item-label">金钻总数 :</td>
                                    <td>
                                        <input type="text" class="form-control input-10x" name="mum_gold" value="<?php echo ($C['mum_gold']); ?>">
                                    </td>
                                    <td class="item-note">
                                    </td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">认购比例 :</td>
                                    <td>
                                        <input type="text" class="form-control input-10x"  name="issue_gold" value="<?php echo ($C['issue_gold']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">抽奖比例 :</td>
                                    <td>
                                        <input type="text" class="form-control input-10x"  name="lottery_gold" value="<?php echo ($C['lottery_gold']); ?>">
                                    </td>
                                    <td class="item-note"></td>
                                </tr>
                                <tr class="controls">
