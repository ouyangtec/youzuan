...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">抽奖设置</span>
        </div>
        <div class="cf">
            <form id="form" action="<?php echo U('duobao/mayEdit');?>" method="post" class="form-horizontal">
                <table>

                    <tr class="controls">
                        <td class="item-label">金钻概率 :</td>
                        <td>
                            <input type="text" class="form-control input-10x" name="gold" value="<?php echo ($gold); ?>">
                        </td>
                        <td class="item-note">
                        </td>
                    </tr>
                    <tr class="controls">
                        <td class="item-label">红钻概率 :</td>
                        <td>
                            <input type="text" class="form-control input-10x"  name="red" value="<?php echo ($red); ?>">
                        </td>
                        <td class="item-note"></td>
                    </tr>
                    <tr class="controls">
                        <td class="item-label">蓝钻概率 :</td>
                        <td>
                            <input type="text" class="form-control input-10x"  name="blue" value="<?php echo ($blue); ?>">
                        </td>
                        <td class="item-note"></td>
                    </tr>
                    <tr class="controls">
           ...
           <!-- <div class="fl">
                <a class="btn btn-success " href="<?php echo U('Duobao/edit');?>">新 增</a>
                <button class="btn  ajax-post btn-info " url="<?php echo U('Duobao/Status',array('type'=>'resume'));?>" target-form="ids">启 用</button>
                <button class="btn ajax-post btn-warning " url="<?php echo U('Duobao/Status',array('type'=>'forbid'));?>" target-form="ids">禁 用</button>
                <button class="btn ajax-post confirm btn-danger " url="<?php echo U('Duobao/Status',array('type'=>'delete'));?>" target-form="ids">删 除</button>
        ...
        <div class="data-table table-striped">
            ...
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><img src="/Upload/duobao/<?php echo ($vo["img"]); ?>" height="30px"/></td>
                            <td>
                                <?php echo ($vo["num"]); ?>
                            </td>
                            <td class=""><?php echo ($vo["poss"]); ?></td>
                            ...
                            <td>
                                <?php if(($vo["name"]) != "cny"): ?><a href="<?php echo U('Duobao/Edit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a><?php endif; ?>
                            </td>
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('duobao/config');?>");
    </script>