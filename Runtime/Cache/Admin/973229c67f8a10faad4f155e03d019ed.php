...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">钻石发放</span>
        </div>
        <div class="tab-wrap">
            <div class="tab-content">
                <form id="form" action="<?php echo U('duobao/maxEdit');?>" method="post" class="form-horizontal">
                                ...
                                <tr class="controls" >
                                    <td>
                                        <fieldset style="padding: .35em .625em .75em;margin: 0 2px;border: 1px solid silver;">
                                            <legend>红钻</legend>
                                            <input type="hidden" class="form-control input-8x" name="redid" value="<?php echo ($red["id"]); ?>">
                                            总额：<input type="text" class="form-control input-8x" name="redmum" value="<?php echo ($red["mum"]); ?>">
                                            拆分数量：<input type="text" class="form-control input-8x"  name="rednum" value="<?php echo ($red["num"]); ?>">
                                        </fieldset>
                                    </td>
                                    <td>
                                        <fieldset style="padding: .35em .625em .75em;margin: 0 2px;border: 1px solid silver;">
                                            <legend>蓝钻</legend>
                                            <input type="hidden" class="form-control input-8x" name="blueid" value="<?php echo ($blue["id"]); ?>">
                                            总额：<input type="text" class="form-control input-8x" name="bluemum" value="<?php echo ($blue["mum"]); ?>">
                                            拆分数量：<input type="text" class="form-control input-8x"  name="bluenum" value="<?php echo ($blue["num"]); ?>">
                                        </fieldset>
                                    </td>
                                    <td>
                                        <fieldset style="padding: .35em .625em .75em;margin: 0 2px;border: 1px solid silver;">
                                            <legend>金钻</legend>
                                            <input type="hidden" class="form-control input-8x" name="goldid" value="<?php echo ($gold["id"]); ?>">
                                            总额：(根据发放总额计算,无法单独修改)<input style="color: black" type="text" readonly class="form-control input-6x" name="goldmum" value="<?php echo ($gold["mum"]); ?>">
                                            拆分数量：<input type="text"  class="form-control input-6x" name="goldnum"  value="<?php echo ($gold["num"]); ?>">
                                        </fieldset>
                                    </td>

                                </tr>
                                <!--<tr class="controls">
                                    <td class="item-label">拆分数量 :</td>
                                    <td>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (addtime($vo["savetime"])); ?></td>
