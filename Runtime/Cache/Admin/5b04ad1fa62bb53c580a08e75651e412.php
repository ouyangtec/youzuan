    ...
    <div id="main" class="main">
        ...
        <div class="tab-wrap">
            <div class="tab-content">
                <form id="form" action="<?php echo U('Issue/save');?>" method="post" class="form-horizontal"  enctype="multipart/form-data">
                    <div id="tab" class="tab-pane in tab">
                        <div class="form-item cf">
                            <table>
                                ...
                                <tr class="controls">
                                    <td class="item-label">宣传图片 :</td>
                                    <td>
                                        <?php if(!empty($data["img"])): ?><!--没有图片显示默认图片-->
                                            <img id="up_img" onclick="getElementById('inputfile').click()" style="cursor:pointer;max-width:500px;" title="点击添加图片" alt="点击添加图片" src="<?php echo ($data["img"]); ?>">
                                            <?php else: ?>
                                            <!--没有图片显示默认图片-->
