        ...
        <div class="data-table table-striped">
            ...
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><span id="name<?php echo ($vo["id"]); ?>"><?php echo ($vo["truename"]); ?></span></td>
                            <td><span id="idcard<?php echo ($vo["id"]); ?>"><?php echo ($vo["idcard"]); ?></span> </td>
                            <td>
                                <span id="sex<?php echo ($vo["id"]); ?>">
                                    <?php if($vo["sex"] == 1): ?>男
                                    <?php else: ?>
                                    女<?php endif; ?>
                                </span>
                            ...
                            <td>
                                <img src="<?php echo ($vo["img"]); ?>" id="<?php echo ($vo["id"]); ?>">
                            </td>
                            <td>
                                <img src="<?php echo ($vo["img2"]); ?>" id="<?php echo ($vo["id"]); ?>">
                            </td>
                            ...
                            <td>
                                <a class="ajax-get btn btn-primary btn-xs" href="<?php echo U('User/smrztg?id='.$vo['id']);?>">通过</a>
                                <a href="<?php echo U('User/smrzjj?id='.$vo['id']);?>" class="ajax-get btn btn-primary btn-xs">拒绝</a>
                            </td>
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        highlight_subnav("<?php echo U('User/smrz');?>");
        ...
        $(function () {
            $("img").click(function () {
                ...
                var idcard=$("#idcard"+id).text();
                var sex=$("#sex"+id).text();
                layer.open({
                    type: 1,
                    title: '姓名:'+name+'；身份证:'+idcard+'；性别：'+sex,
                    closeBtn: 0,
                    area: '516px',
                    skin: 'layui-layer-nobg', //没有背景色
                    shadeClose: true,
                    content: '<div><img src="'+a+'" style="width: 100%;height: 100%"></div>'
                });
            })
        })
    </script>