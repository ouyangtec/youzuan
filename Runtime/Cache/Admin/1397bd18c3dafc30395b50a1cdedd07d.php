                                ...
                                <tr class="controls" >
                                    <td>
                                        <fieldset style="padding: .35em .625em .75em;margin: 0 2px;border: 1px solid silver;">
                                            <legend>红钻</legend>
                                            总额：<input type="text" class="form-control input-10x" name="redmum" value="">
                                            拆分数量：<input type="text" class="form-control input-10x"  name="rednum" value="">
                                        </fieldset>
                                    </td>
                                    <td>
                                        <fieldset style="padding: .35em .625em .75em;margin: 0 2px;border: 1px solid silver;">
                                            <legend>蓝钻</legend>
                                            总额：<input type="text" class="form-control input-10x" name="bluemum" value="">
                                            拆分数量：<input type="text" class="form-control input-10x"  name="bluenum" value="">
                                        </fieldset>
                                    </td>
