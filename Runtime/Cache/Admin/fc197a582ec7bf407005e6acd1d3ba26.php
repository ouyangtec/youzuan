		...
		<div class="data-table table-striped">
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>-</td>
                        <td class="action">
                            <a class=" btn-xs btn-info"  href="<?php echo U('Tools/xiazai');?>?file=<?php echo (date('Ymd-His',$data["time"])); ?>-1.sql.gz">下载</a>


                            <a class="db-import  btn-primary btn-xs" href="<?php echo U('Tools/import?time='.$data['time']);?>">还原</a>
                          <a class="ajax-get confirm btn-danger btn-xs" href="<?php echo U('Tools/del?time='.$data['time']);?>">删除</a>
                        </td>
