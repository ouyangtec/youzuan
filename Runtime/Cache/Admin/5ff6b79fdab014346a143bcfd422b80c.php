...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Finance/myczType');?>">人民币充值方式列表</a>  >></span>
            <span class="h1-title"><?php if(empty($data)): ?>添加人民币充值方式
	            <?php else: ?>
                                                      编辑人民币充值方式<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Finance/myczTypeEdit');?>" method="post" class="form-horizontal">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<input type="password" class="form-control input-10x" name="password" value="<?php echo ($data["password"]); ?>" >
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="kaihu" value="<?php echo ($data["kaihu"]); ?>" >
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
										<div id="addpicContainer">
											...
											<?php if(!empty($data["img"])): ?><!--没有图片显示默认图片-->
												<img id="up_img" onclick="getElementById('inputfile').click()" style="cursor:pointer;max-width:500px;" title="点击添加图片" alt="点击添加图片" src="/Upload/public/<?php echo ($data["img"]); ?>">
												<?php else: ?>
												<!--没有图片显示默认图片-->
