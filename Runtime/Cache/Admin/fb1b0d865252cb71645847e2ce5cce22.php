...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="main-title-h">
            ...
            <span class="h1-title"><a href="<?php echo U('Trade/seeklist');?>">市场列表</a> >></span>
        ...
        <div class="tab-wrap">
            ...
            <div class="tab-content">
                ...
                <form id="form" action="<?php echo U('Trade/seekEdit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <table>
                                ...
                                <?php if(empty($data['id'])): ?><tr class="controls">
                                        ...
                                        <td><select name="buyname" class="form-control input-10x">
                                            ...
                                            <?php if(is_array($C['coin'])): $i = 0; $__LIST__ = $C['coin'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!--<?php if($v['name'] == cny || $v['name'] == usd || $v['name'] == btc || $v['name'] == ltc): endif; ?>-->
                                                <option value="<?php echo ($v['name']); ?>"><?php echo ($v['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>

                                        </select>

                                        </td>

                                        <td class="item-note">区域</td>
                                    ...
                                    <tr class="controls">
                                        ...
                                        <td><!--<select name="sellname" class="form-control input-10x">
                                            ...
                                            <input name="sellname" type="text" class="form-control input-10x" >
                                        </td>
                                ...
                                <tr class="controls">
                                    ...
                                    <td class="item-label">挂单手续费:</td>

                                    <td>

                                        <input type="text" class="form-control input-10x" name="fee_seek" value="<?php echo ($data["fee_seek"]); ?>">

                                    </td>

                                    <td class="item-note">金钻,有挂单的时候不能再修改</td>
