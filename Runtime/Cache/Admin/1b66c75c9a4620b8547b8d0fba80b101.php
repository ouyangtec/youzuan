					...
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">联系微信:</td>
									<td>
										<input type="text" class="form-control input-10x" name="contact_weixin" value="<?php echo ($C['contact_weixin']); ?>">
									</td>
									<td class="item-note">联系微信 多个用户“|”分割</td>
								</tr>
								<tr class="controls">
