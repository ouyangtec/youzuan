...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">蓝钻回购</span>
        </div>
        <div class="tab-wrap">
            <div class="tab-content">
                <form id="form" action="<?php echo U('Trade/repurchase');?>" method="post" class="form-horizontal">
                    <div id="tab" class="tab-pane in tab">
                        <div class="form-item cf">
                            <table>

                                <tr class="controls">
                                    <td class="item-label">每日回购:</td>
                                    <td>
                                        <input type="text" class="form-control input-10x" name="requrchasenum" value="<?php echo ($C['requrchasenum']); ?>">
                                    </td>
                                    <td class="item-note">
                                    </td>
                                </tr>
                                <tr class="controls">
                                    <td class="item-label">回购价格 :</td>
                                    <td>
                                        <input type="text" class="form-control input-10x"  name="requrchaseprice" value="<?php echo ($C['requrchaseprice']); ?>">
                                    </td>
