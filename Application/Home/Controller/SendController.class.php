...
class SendController extends HomeController
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIhEZlBmPRNXOY"; // AccessKeyId

        $accessKeySecret = "vVq2rKL3jzq2t6sDxQKm86F59zmtU2"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($moble,$code,$template) {
